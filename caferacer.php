...
<head>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="asset/caferacer2.jpg" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="asset/caferacer3.jpg" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="asset/caferacer4.jpg" alt="Third slide">
    </div>
  ...
  <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
      ...
      <p class="bestbike text-center">BEST</p>
          <h3>Husqvarna Vitpilen 701 Cafe Racer</h3>
          <h4>Rp.180,000,000</h4>
          <p>Spesifikasi : <br>
          Tenaga Maksimal : 73.75 hp,
          Jenis Mesin : Single Cylinder, 4-Stroke Engine,
          Opsi start : Opsi start,
          Jenis Bahan Bakar : Bensin,
          Kecepatan maksimum : 218 kmph,
          Rasio Kompresi : 12.8:1,
          RPM torsi maksimum : 6750 rpm,
          Sistem pelumasan : Forced Oil Lubrication with 2 Oil Pumps,
          RPM Tenaga Maksimum : 8500 rpm,
          Jenis Kopling : APTC Slipper Clutch,
          Pipa Knalpot : Single Exhuast,
          Kapasitas(cc) : 692.7,
          Sistem bahan bakar : EFI,
          Ketinggian Jok : 830 mm,
          Suspensi Belakang : WP Shock Absorber,
          Suspensi Depan : WP Monoshock,
          Travel Suspensi depan & belakang : 135 mm,
          Ukuran velg depan & belakang : R17,
          Ban depan : 120/70 R17,
          Ban belakang : 160/60 R17,
          Jenis Ban : Radial.
          </p>
          <p><a href="https://api.whatsapp.com/send?phone=<?php echo $a->admin_telp ?>&text= Hallo kak, saya tertarik dengan Best Produk Dobu Garage yaitu Husqvarna Vitpilen 701 Cafe Racer" target="_blank" class="btn btn-outline-success">Order Via Whatsaap</a></p>
