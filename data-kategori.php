...
<head>
  ...
  <!-- Navbar End -->
    ...
    <div class="section">
        <div class="container">
            <h3 class="dsh">Kategori</h3>
            <div class="box">
            <p><a href="tambah-kategori.php" class="btn btn-outline-primary">Tambah Kategori</a></p>
            <table border="1" cellspacing="0" class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="edit-kategori.php?id=<?php echo $row['category_id'] ?>" class="btn btn-outline-primary" >Edit</a> || 
                            <a href="proses-hapus.php?id=<?php echo $row['category_id'] ?>" onclick="return confirm('Anda yakin ingin hapus ?')" class="btn btn-outline-danger">Hapus</a>
                        </td>
                    </tr>
                    <?php }}else{ ?>
                        <tr>
