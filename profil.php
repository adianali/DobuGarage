...
<head>
  ...
  <!-- Navbar End -->
    ...
    <div class="section">
        <div class="container">
            <h3 class="dsh">Profile</h3>
            <div class="box">
                <form action="" method="POST">
                    <input type="text" name="nama" placeholder="Nama Lengkap" class="input-control" value="<?php echo $d->admin_nama ?>" require>
                    ...
                    <input type="text" name="alamat" placeholder="Alamat" class="input-control" value="<?php echo $d->admin_alamat ?>" require>
                    ...
                    if(isset($_POST['ubah_password'])){
                      ...
                      if($pass2 != $pass1){
                        ...
                        $u_pass = mysqli_query($conn, "UPDATE tb_admin SET 
                                                ...
                                                WHERE admin_id = '".$d->admin_id."' ");
                      if($u_pass){
                          echo '<script>alert("Ubah Data Password Berhasil")</script>';
                          echo '<script>window.location="profil.php"</script>';
                      }else{
                        echo 'gagal '.mysqli_error($conn);
                      }
