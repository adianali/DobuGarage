        ...
        <div class="container">
            ...
            <table border="1" cellspacing="0" class="table">
                ...
                <tbody>
                    <?php
                        $no = 1;
                        $pesan = mysqli_query($conn, "SELECT * FROM tb_kontak  ORDER BY kontak_id ASC");
                    ...
                    <tr>
                        ...
                        <td><?php echo $row['pesan_user'] ?></td>
                        
                        <td>
                            <a href="proses-hapus.php?idk=<?php echo $row['kontak_id'] ?>" onclick="return confirm('Anda yakin ingin hapus ?')" class="btn btn-outline-danger">Hapus</a>
                        </td>
                    </tr>
                    <?php }} else { ?>
                        <tr>
